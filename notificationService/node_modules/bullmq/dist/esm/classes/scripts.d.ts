...
import { JobJson, JobJsonRaw, MinimalJob, MoveToWaitingChildrenOpts, ParentOpts, RedisClient, KeepJobs, MoveToDelayedOpts, RepeatableOptions } from '../interfaces';
...
export declare class Scripts {
    ...
    retryJob(jobId: string, lifo: boolean, token: string, fieldsToUpdate?: Record<string, any>): Promise<void>;

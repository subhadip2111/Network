...
const {createFeedPost,getfeedsBasedOnUserProfile,getfeddDetailsById,editFeedPost,deleteFeedPost, uploadFeedImageController}= require('../Controller/feedController');
...
feedRouter.patch('/uploads/:postId', authentication,uploadFeedImageController);
